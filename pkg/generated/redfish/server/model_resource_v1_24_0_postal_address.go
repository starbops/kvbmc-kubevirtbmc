...
// AssertResourceV1240PostalAddressRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertResourceV1240PostalAddressRequired(obj ResourceV1240PostalAddress) error {
	return nil
}

// AssertResourceV1240PostalAddressConstraints checks if the values respects the defined constraints
func AssertResourceV1240PostalAddressConstraints(obj ResourceV1240PostalAddress) error {
	return nil
}
