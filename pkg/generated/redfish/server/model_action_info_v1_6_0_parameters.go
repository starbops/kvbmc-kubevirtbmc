...
// AssertActionInfoV160ParametersRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertActionInfoV160ParametersRequired(obj ActionInfoV160Parameters) error {
	return nil
}

// AssertActionInfoV160ParametersConstraints checks if the values respects the defined constraints
func AssertActionInfoV160ParametersConstraints(obj ActionInfoV160Parameters) error {
	return nil
}
